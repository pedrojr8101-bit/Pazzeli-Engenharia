...
export function BotaoWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 rounded-full bg-[#25D366] px-5 py-3 text-sm font-semibold text-graphite shadow-lg transition hover:scale-105"
    >
      <svg viewBox="0 0 24 24" className="h-5 w-5 fill-graphite" aria-hidden>
