...
const SERVICOS = [
  ...
  },
  {
    ...
    foto:
      "https://images.unsplash.com/photo-1680355065203-43ad84bb6e69?fm=jpg&q=80&w=1200&auto=format&fit=crop",
  ...
  },
  {
    ...
    foto:
      "https://images.unsplash.com/photo-1677273459827-e212995b079d?fm=jpg&q=80&w=1200&auto=format&fit=crop",
  ...
  },
  {
    ...
    foto:
      "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?fm=jpg&q=80&w=1200&auto=format&fit=crop",
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {SERVICOS.map((servico) => {
            const mensagem = encodeURIComponent(
              `Olá! Vim pelo site e gostaria de solicitar um orçamento de ${servico.titulo}, sem compromisso.`
            );

            return (
              <div
                key={servico.titulo}
                className="flex flex-col overflow-hidden rounded-xl border border-borderlight bg-ivory transition hover:border-sun"
              >
                ...
                <div className="flex flex-1 flex-col p-6">
                  ...
                  <p className="mt-2 flex-1 text-sm leading-relaxed text-graphitesoft">
                    {servico.texto}
                  </p>
                  ...
                  {Boolean(whatsapp) && (
                    <a
                      ...
                      className="mt-4 inline-flex items-center justify-center gap-2 rounded-full border border-borderlight px-4 py-2 text-xs font-semibold text-graphite transition hover:border-sun hover:text-sun"
                    >
                      Solicitar orçamento
